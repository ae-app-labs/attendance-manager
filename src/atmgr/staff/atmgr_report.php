...
// Reports can only be generated by valid staff only
...
// - staff dept
	...
	$resD = mysql_query("SELECT * FROM department WHERE dept_id = (SELECT dept FROM user_staff WHERE staff_id = '$staff_id')",$db);
...
// date("d-m-y",$timeStampStart);
	...
	else
	{
		...
		for($iCounter = 0;$iCounter<$numStudents;$iCounter++)
		{
			...
			$attendanceSpan   = ($totalPresentDays/$daysSpan) * 100;
