...
<?php include("staff_navigation.php");  ?>
	<div id="staff-content">
	  ...
	  <p>Select the department, the class and the hour for marking the attendance. Clicking in the button &quot;Mark Attendance&quot; will give you a new page with the listing of all the students from the specified class. In case of a lab , you can select the Use same for the next 1 or 2 hours. </p>
	  <form id="f_studAttenSelect" name="f_studAttenSelect" method="post" 
	  		action="staff_markAttendance.php" onsubmit="return validateForm(this.form);">
	    ...
	    Use same for the next 
	    <select name="lstMultiple" id="lstMultiple">
	    ...
	    Hours.
	    <p>
	      <input type="submit" name="Submit" value="Mark Attendance" onclick="return validateForm(this.form);" />
	    </p>
	  </form>
	  <p>&nbsp;</p>
	</div>
