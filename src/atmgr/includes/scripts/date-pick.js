...
Calendar.prototype.getMonthlyCalendarCode = function() {
	...
	vCode += ("<div align=center><TABLE BORDER=0 BGCOLOR=\"#ffffff\" style='font-size:" + fontsize + "pt;'>");
...
Calendar.prototype.show = function() {
	...
	ggWinContent += ("<TABLE WIDTH='100%' BORDER=1 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#ffffff' style='font-size:" + fontsize + "pt;'><TR><TD ALIGN=center>");
...
Calendar.prototype.format_data = function(p_day) {
	...
	var vMon = Calendar.get_month(this.gMonth).substr(0,3).toLowerCase();
