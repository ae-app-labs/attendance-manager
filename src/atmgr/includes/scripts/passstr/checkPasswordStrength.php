...
{
echo '<img src="images/usecure.gif"/><br/><font color="#63dc39"><b>Uber Secure! (Best)</b></font>';
...
{
echo '<img src="images/secure.gif"/><br/><font color="#c0f813"><b>Secure</b></font>';
...
{
echo '<img src="images/good.gif"/><br/><font color="#f87a13"><b>Good</b></font>';
}elseif((CheckNum($usrinput)==true)||(CheckForUPcase($usrinput)==true)||(CheckSPCHAR($usrinput)==true)||($output>='8'))
//if any 1 condition is true
{
echo '<img src="images/weak.gif"/><br/><font color="#f01212"><b>Weak</b></font>';
}else{
// if none of the condtions return true
echo '<img src="images/pweak.gif"/><br/><b>Pretty Weak</b>';
}
